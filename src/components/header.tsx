...
const Header = () => {
  return (
    // main div
    <div className="w-full h-auto bg-white border-2 font-sans">
    ...
    <div className="w-full h-auto flex items-center justify-between px-6 sm:px-12 md:px-20 py-4 fixed top-0 bg-white shadow-md z-10">
      ...
      <ul className="hidden md:flex items-center space-x-6 font-extrabold text-sm md:text-base lg:text-lg">
        <Link href={"/"}><li className="hover:text-[#B88E2F] cursor-pointer transition-all">Home</li></Link>
        <Link href={"/shop"}><li className="hover:text-[#B88E2F] cursor-pointer transition-all">Shop</li></Link> 
        <Link href={"/about"}><li className="hover:text-[#B88E2F] cursor-pointer transition-all">About</li></Link>
        <Link href={"/contact"}><li className="hover:text-[#B88E2F] cursor-pointer transition-all">Contact</li></Link>
      </ul>
