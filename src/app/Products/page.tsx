...
const ProductCards: React.FC = () => {
    ...
    return (
        <div className="p-4">
            <h2 className="text-center text-slate-800 mt-4 mb-4 text-4xl font-bold">Products From API Data</h2>
                ...
                {products.map((product) => (
                    ...
                    >
                        ...
                        <div className="mt-4">
                            ...
                            <button
                                className="mt-4 w-full bg-[#B88E2F] text-white py-2 rounded-md hover:bg-blue-700"
                        ...
                        {cart.map((item, index) => (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-[#B88E2F]">${item.price.toFixed(2)}</p>
                                </div>
